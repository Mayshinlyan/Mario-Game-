...
public class nightLevel {
	...
	public nightLevel(){
		...
		//adding ground to the array list 
		ground.add(g1);
		ground.add(g2);
		ground.add(g3);
		ground.add(g4);
	...
	public void initPowerups() {
		...
		Powerups p12 = new Powerups(900, 400,2);
	...
	//method to check for power up hit 
	...
	//array list keep the hazards. 
	List<Hazards> hazard = new ArrayList<Hazards>();

	//method to initialize hazard
